...
#define START_TIME_BLOCK 8
#define END_TIME_BLOCK 9
#define PROCESS_TIME_BLOCK 10

extern uint8_t NFCState;


uint32_t pn532_init(void);
...
//uint8_t tgSetData(const uint8_t *header, uint8_t hlen);

//int16_t inRelease(const uint8_t relevantTarget );

// ISO14443A functions
//uint8_t inListPassiveTarget(void);
