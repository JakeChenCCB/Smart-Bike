...
#define BTN_ID_WAKEUP             13  /**< ID of button used to wake up the application. */
#define BTN_ID_SLEEP              13  /**< ID of button used to put the application into sleep mode. */
#define BTN_ID_DISCONNECT         13  /**< ID of button used to gracefully terminate a connection on long press. */
#define BTN_ID_WAKEUP_BOND_DELETE 14  /**< ID of button used to wake up the application and delete all bonding information. */
#define BTN_ID_WHITELIST_OFF      15  /**< ID of button used to turn off usage of the whitelist. */
